...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (34:2)\n\n  32 | \t\treturn (\n  33 | \t\t<h1 className = 'registerText'>Register</h1>\n> 34 | \t\t<div className = 'container'>\n     | \t\t^\n  35 | \t  \t\t<div className = 'contained'>\n  36 | \t  \t\t\t<form method = '' action = '' className = 'registerForm'>\n  37 | \t  \t\t\t\t<div className = 'group'>\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-1f1ae12d2a10b4a1f8b6.js.map