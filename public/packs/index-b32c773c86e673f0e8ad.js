...
/* 11 */
/*!************************************************************!*\
  !*** ./app/javascript/packs/Components/RegisterFooter.jsx ***!
  \************************************************************/
...
var RegisterFooter = function (_React$Component) {
	_inherits(RegisterFooter, _React$Component);

	function RegisterFooter(props) {
		_classCallCheck(this, RegisterFooter);

		var _this = _possibleConstructorReturn(this, (RegisterFooter.__proto__ || Object.getPrototypeOf(RegisterFooter)).call(this, props));

		Object.defineProperty(_this, 'slideUpForgot', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				console.log('slideUpForgot');
			}
		});
		Object.defineProperty(_this, 'slideUpLogin', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'forgotRegister' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'a',
						{ href: '/forgot', className: 'registerLinkForgot', onClick: this.slideUpForgot },
						' Forgot? '
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'a',
							{ href: '', className: 'registerLink', onClick: this.slideUpLogin },
							' Login '
						)
					)
				)
...
/* harmony default export */ __webpack_exports__["default"] = (RegisterFooter);

/***/ }),
/* 12 */
/*!**********************************************************!*\
  !*** ./app/javascript/packs/Components/RegisterForm.jsx ***!
  \**********************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(/*! react-dom */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RegisterFooter__ = __webpack_require__(/*! ./RegisterFooter */ 11);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RegisterForm = function (_React$Component) {
	...
	function RegisterForm(props) {
		...
		Object.defineProperty(_this, 'handlePassword', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				_this.setState({ password: ev.target.val });
			}
		});
		Object.defineProperty(_this, 'handleUsername', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				_this.setState({ name: ev.target.val });
			}
		});
		Object.defineProperty(_this, 'handleRegister', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				ev.preventDefault();
				_this.props.onSubmit && _this.props.onSubmit(_this.state.name, _this.state.password);
			}
		});
	...
	_createClass(RegisterForm, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'p',
					{ className: 'smallRegisterText' },
					'For your security, passwords must include an upper case letter and at least one number. '
				),
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'form',
						{ method: '', action: '', className: 'registerForm' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'group' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { onChange: this.handleUsername, name: 'Username', type: 'text', placeholder: 'Username', className: 'usernameRegister' }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('hr', { className: 'registerLine' }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('br', null),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { onChange: this.handlePassword, name: 'Password', type: 'text', placeholder: 'Password', className: 'passwordRegister' }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('hr', { className: 'registerLine' }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'signinRegister' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { name: 'Register', onClick: this.handleRegister, value: '     Next     ', className: 'inputSigninRegister' })
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__RegisterFooter__["default"], null)
						)
					)
				)
			);
...
/* 13 */
/*!**************************************************!*\
  !*** ./app/javascript/packs/Components/Year.jsx ***!
  \**************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Register = function (_React$Component) {
	...
	function Register(props) {
		...
		Object.defineProperty(_this, 'yearSelected', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				console.log(ev.target.val);
				_this.setState({ year: ev.target.val });
				_this.props.onChange && _this.props.onChange(_this.state.yearSelected);
				return;
			}
		});
		...
		_this.yearSelected = _this.yearSelected.bind(_this);
		return _this;
	}
	...
	_createClass(Register, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				null,
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'Freshman', value: 'Freshman', type: 'checkbox', onChange: this.yearSelected }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'Sophomore', value: 'Sophomore', type: 'checkbox', onChange: this.yearSelected }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'Junior', value: 'Junior', type: 'checkbox', onChange: this.yearSelected }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'Senior', value: 'Senior', type: 'checkbox', onChange: this.yearSelected }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: '5th year Senior', value: '5th year Senior', type: 'checkbox', onChange: this.yearSelected }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'Graduate Student', value: 'Graduate Student', type: 'checkbox', onChange: this.yearSelected })
			);
		}
	}]);
...
/* 14 */
/*!******************************************************!*\
  !*** ./app/javascript/packs/Components/Register.jsx ***!
  \******************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(/*! react-dom */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RegisterForm_jsx__ = __webpack_require__(/*! ./RegisterForm.jsx */ 12);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Register = function (_React$Component) {
	...
	_createClass(Register, [{
		key: 'sendInfo',
		value: function sendInfo(name, password, success) {
			//make request here
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				null,
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__RegisterForm_jsx__["default"], { name: 'Username', password: 'Password', onSubmit: this.sendInfo })
			);
		}
	}]);
...
/* 15 */
/*!********************************************************!*\
  !*** ./app/javascript/packs/Components/SwitchForm.jsx ***!
  \********************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(/*! react-dom */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Year_jsx__ = __webpack_require__(/*! ./Year.jsx */ 13);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RegisterForm = function (_React$Component) {
	...
	function RegisterForm(props) {
		...
		Object.defineProperty(_this, 'handleMajors', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				_this.setState({ majors: ev.target.val });
			}
		});
		Object.defineProperty(_this, 'handleYear', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
		...
		Object.defineProperty(_this, 'handleInterests', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				ev.preventDefault();
				_this.setState({ interests: ev.target.val });
			}
		});
		Object.defineProperty(_this, 'handleSubmit', {
			...
			value: function value(ev, val) {
				ev.persist();
				ev.preventDefault();
				_this.props.onSubmit && _this.props.onSubmit(_this.state.majors, _this.state.interests, _this.state.year);
			}
		});
		Object.defineProperty(_this, 'showYear', {
			enumerable: true,
			writable: true,
			value: function value(ev, val) {
				ev.persist();
				ev.preventDefault();
				var adder = _this.state.majors;
				adder.push(ev.target.val);
				console.log(12);
				_this.setState({ showYear: true });
				console.log(_this.state.showYear);
			}
		});
		...
		_this.handleMajors = _this.handleMajors.bind(_this);
		_this.handleYear = _this.handleYear.bind(_this);
		_this.handleInterests = _this.handleInterests.bind(_this);
		_this.showYear = _this.showYear.bind(_this);
		return _this;
	}
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'td',
					null,
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-bar-chart', 'aria-hidden': 'true' })
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'h1',
					{ className: 'registerTextLarge' },
					'About you'
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'p',
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'form',
						{ method: '', action: '', className: 'registerFormRadios' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'groupFlex' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'label',
								null,
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { onChange: this.handleMajors, type: 'checkbox', name: 'Major', placeholder: 'Majors', value: 'Economics' }),
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'yearHolder', style: { animation: this.state.showYear ? 'opacitySlide 0.3s ease-in forward' : 'none' } },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Year_jsx__["default"], { onChange: this.handleYear })
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { name: 'Register', onClick: this.showYear, value: '     Next     ', className: 'inputSigninRegister' })
					)
				)
			);
		}
...
if (true) {
  ...
  module.exports = __webpack_require__(/*! ./factoryWithTypeCheckers */ 17)(isValidElement, throwOnDirectAccess);
} else {
...
module.exports = __webpack_require__.p + "_/assets/images/back-51699aba363c9e1e7b8686d30113f705.png";

/***/ }),
/* 19 */
/*!****************************************************!*\
  !*** ./app/javascript/packs/Components/Switch.jsx ***!
  \****************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(/*! react-dom */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SwitchForm_jsx__ = __webpack_require__(/*! ./SwitchForm.jsx */ 15);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Register = function (_React$Component) {
	...
	_createClass(Register, [{
		key: 'newUser',
		value: function newUser(name, password, success) {
			this.setState(success);
			this.props.onSubmit && this.props.onSubmit(name, password);
			return;
		}
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				null,
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__SwitchForm_jsx__["default"], { majors: 'Majors', onSubmit: this.newUser })
			);
		}
	}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Components_Register__ = __webpack_require__(/*! ./Components/Register */ 14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Components_Switch__ = __webpack_require__(/*! ./Components/Switch */ 19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png__ = __webpack_require__(/*! ./../../assets/images/back.png */ 18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__assets_images_back_png__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var registerStyle = {
	backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')'
};

document.addEventListener('DOMContentLoaded', function () {
	__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(App, null), document.body.appendChild(document.createElement('div')));
});
...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.newUser = _this.changeStyle.bind(_this);
		return _this;
	}

	_createClass(App, [{
		key: 'changeStyle',
		value: function changeStyle(name, password) {
			this.setState({ transform: true, name: name, password: password });
		}
	}, {
		key: 'newUser',
		value: function newUser(majors, interests, year) {
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'REGISTERCONTAINER', style: registerStyle },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'whiteContainer', style: { animation: this.state.transform ? 'slider 0.5s ease-in-out forwards' : 'none' } },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'container' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Components_Register__["default"], { username: 'Username', password: 'Password', onSubmit: this.changeStyle })
							)
						)
					)
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'extraContainer', style: { backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')' } },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'switchContainer', style: { background: 'transparent', animation: this.state.transform ? 'sliderSwitch 0.8s ease-in-out forwards' : 'none', display: this.state.transform ? 'flex' : 'none' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'switchWhiteContainer' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'container' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Components_Switch__["default"], { username: 'Username', password: 'Password', onSubmit: this.newUser })
							)
						)
					)
				)
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-b32c773c86e673f0e8ad.js.map