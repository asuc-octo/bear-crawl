		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'whiteContainer', style: { animation: this.state.transform ? 'slider 0.8s ease-in forwards' : 'none', display: this.state.transform ? 'block' : 'flex', position: this.state.transform ? 'static' : 'absolute' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'container' },
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'SWITCHCONTAINER', style: { display: this.state.transform ? 'flex' : 'none', backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'switchWhiteContainer', style: { animation: this.state.transform ? 'sliderSwitch 0.5s ease-in forwards' : 'none' } },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-64059727025755b9c34f.js.map