	...
	_createClass(App, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'extraContainerr', style: { animation: this.state.transform ? 'sliderSwitch 0.8s ease-in forwards' : 'none' } },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'switchContainer', style: { backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')', animation: this.state.transform ? 'displayer' : 'none' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-0faf1e20cbb20330f7a8.js.map