	...
	_createClass(App, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'extraContainerr', style: {} },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'switchContainer', style: { animation: this.state.transform ? 'sliderSwitch 0.8s ease-in forwards' : 'none', backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')', display: this.state.transform ? 'flex' : 'none' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-27bdca42fdd743e8938e.js.map