...
throw new Error("Module build failed: SyntaxError: Expected corresponding JSX closing tag for <form> (58:6)\n\n  56 | \t\t\t\t\t\t\t\t<button name = 'Register' onClick = {this.handleRegister} value='     Next     ' className = 'inputSigninRegister' />\n  57 | \t\t\t\t\t\t\t</div>\n> 58 | \t\t\t\t\t\t</div>\n     | \t\t\t\t\t\t^\n  59 | \t\t\t\t\t</form>\n  60 | \t\t\t\t</div>\n  61 | \t\t\t</div>\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-832904e4d39b6a6a7455.js.map