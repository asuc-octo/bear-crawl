		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'REGISTERCONTAINER', style: { display: this.state.transform ? 'inherit' : 'none', backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_5__assets_images_back_png___default.a + ')' } },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'whiteContainer', style: { animation: this.state.transform ? 'sliderSwitch 0.5s ease-in forwards' : 'none' } },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'container' },
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-7756558114fdc91f0048.js.map